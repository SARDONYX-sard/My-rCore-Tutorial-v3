...
/// The max number of direct index nodes
...
impl SuperBlock {
    ...
    /// Determine if the file system with the superblock is legal with a magic number.
...
impl DiskInode {
    ...
    /// Round up the value to fit the required number of blocks.
